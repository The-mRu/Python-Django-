...
#task:1,2,3
# name=input("Nam ki? : ")
# age=int(input("Boyosh kotw? : "))
# fav_color=input("Ki rong vlo lage? : ")
# # print(name,age,color)
# print("ur color",color)
# print(f"ur color {color}")
...
a=5
b=3
print("a==b :", a==b) #is a,b equal?
print("a>b : ",a>b) # is a less thab a ?
